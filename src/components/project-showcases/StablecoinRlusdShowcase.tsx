...
const STABLECOIN_SHOWCASE_DATA: ShowcaseItem[] = [
    { src: '/stablecoin_rlusd/stablecoin_rlusd-mock1.png', alt: 'Stablecoin RLUSD Branding', colSpan: 4, ratio: 'wide', type: 'img' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-motion1.mp4', alt: 'Stablecoin RLUSD Social Card', colSpan: 2, ratio: 'wide', type: 'video' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-motion2.mp4', alt: 'Stablecoin RLUSD Intro video', colSpan: 2, ratio: 'wide', type: 'video' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-website.mp4', alt: 'Stablecoin RLUSD Signage', colSpan: 2, ratio: 'wide', type: 'video' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-colors.mp4', alt: 'Stablecoin RLUSD Check In', colSpan: 2, ratio: 'wide', type: 'video' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-copy.mp4', alt: 'Stablecoin RLUSD Signage', colSpan: 2, ratio: 'wide', type: 'video' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-subtle_coin.mp4', alt: 'Stablecoin RLUSD Check In', colSpan: 2, ratio: 'wide', type: 'video' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-watch.png', alt: 'Stablecoin RLUSD Stage', colSpan: 4, ratio: 'wide', type: 'img' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-social.png', alt: 'Stablecoin RLUSD Signage', colSpan: 1, ratio: 'square', type: 'img' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-swag.png', alt: 'Stablecoin RLUSD Check In', colSpan: 1, ratio: 'square', type: 'img' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-coins.png', alt: 'Stablecoin RLUSD Signage', colSpan: 1, ratio: 'square', type: 'img' },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-illustration.png', alt: 'Stablecoin RLUSD Signage', colSpan: 1, ratio: 'square', type: 'img' },
    {
    title: 'RIPPLE USD SPARKED BUZZ, LANDING ON FOX BUSINESS.',
    description: 'See for youreslf. Check out the ',
    linkText: ' tweet.',
    linkHref: 'https://x.com/EleanorTerrett/status/1869088656268685730',
    colSpan: 2,
    ratio: 'wide',
    type: 'text',
    },
    { src: '/stablecoin_rlusd/stablecoin_rlusd-tv.png', alt: 'Stablecoin RLUSD Signage', colSpan: 2, ratio: 'wide', type: 'img' },
];
...
export const StablecoinRlusdShowcase = (): React.ReactElement => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
      {STABLECOIN_SHOWCASE_DATA.map((item, index) => {
